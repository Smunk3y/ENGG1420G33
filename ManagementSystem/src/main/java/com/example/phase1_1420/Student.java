...
public class Student extends User {
    ...
    public Student(String id, String password, String username, String email, String address, String telephone,
        ...
        this.progress = progress;  // Removed multiplication by 100
        this.email = email;
        this.thesis = thesis;
    }
    ...
    public void setProgress(double progress) { this.progress = progress; } // Removed multiplication by 100
